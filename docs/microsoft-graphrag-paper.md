...
1. [1 Introduction](https://arxiv.org/html/2404.16130v2#S1 "In From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
2. [2 Background](https://arxiv.org/html/2404.16130v2#S2 "In From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
   1. [2.1 RAG Approaches and Systems](https://arxiv.org/html/2404.16130v2#S2.SS1 "In 2 Background ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
   2. [2.2 Using Knowledge Graphs with LLMs and RAG](https://arxiv.org/html/2404.16130v2#S2.SS2 "In 2 Background ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
   3. [2.3 Adaptive benchmarking for RAG Evaluation](https://arxiv.org/html/2404.16130v2#S2.SS3 "In 2 Background ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
   4. [2.4 RAG evaluation criteria](https://arxiv.org/html/2404.16130v2#S2.SS4 "In 2 Background ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
3. [3 Methods](https://arxiv.org/html/2404.16130v2#S3 "In From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
   1. [3.1 GraphRAG Workflow](https://arxiv.org/html/2404.16130v2#S3.SS1 "In 3 Methods ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
      1. [3.1.1 Source Documents →\rightarrow→ Text Chunks](https://arxiv.org/html/2404.16130v2#S3.SS1.SSS1 "In 3.1 GraphRAG Workflow ‣ 3 Methods ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
      2. [3.1.2 Text Chunks →\rightarrow→ Entities & Relationships](https://arxiv.org/html/2404.16130v2#S3.SS1.SSS2 "In 3.1 GraphRAG Workflow ‣ 3 Methods ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
      3. [3.1.3 Entities & Relationships →\rightarrow→ Knowledge Graph](https://arxiv.org/html/2404.16130v2#S3.SS1.SSS3 "In 3.1 GraphRAG Workflow ‣ 3 Methods ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
      4. [3.1.4 Knowledge Graph →\rightarrow→ Graph Communities](https://arxiv.org/html/2404.16130v2#S3.SS1.SSS4 "In 3.1 GraphRAG Workflow ‣ 3 Methods ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
      5. [3.1.5 Graph Communities →\rightarrow→ Community Summaries](https://arxiv.org/html/2404.16130v2#S3.SS1.SSS5 "In 3.1 GraphRAG Workflow ‣ 3 Methods ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
      6. [3.1.6 Community Summaries →\rightarrow→ Community Answers →\rightarrow→ Global Answer](https://arxiv.org/html/2404.16130v2#S3.SS1.SSS6 "In 3.1 GraphRAG Workflow ‣ 3 Methods ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
   2. [3.2 Global Sensemaking Question Generation](https://arxiv.org/html/2404.16130v2#S3.SS2 "In 3 Methods ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
   3. [3.3 Criteria for Evaluating Global Sensemaking](https://arxiv.org/html/2404.16130v2#S3.SS3 "In 3 Methods ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
4. [4 Analysis](https://arxiv.org/html/2404.16130v2#S4 "In From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
   1. [4.1 Experiment 1](https://arxiv.org/html/2404.16130v2#S4.SS1 "In 4 Analysis ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
      1. [4.1.1 Datasets](https://arxiv.org/html/2404.16130v2#S4.SS1.SSS1 "In 4.1 Experiment 1 ‣ 4 Analysis ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
      2. [4.1.2 Conditions](https://arxiv.org/html/2404.16130v2#S4.SS1.SSS2 "In 4.1 Experiment 1 ‣ 4 Analysis ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
      3. [4.1.3 Configuration](https://arxiv.org/html/2404.16130v2#S4.SS1.SSS3 "In 4.1 Experiment 1 ‣ 4 Analysis ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
   2. [4.2 Experiment 2](https://arxiv.org/html/2404.16130v2#S4.SS2 "In 4 Analysis ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
5. [5 Results](https://arxiv.org/html/2404.16130v2#S5 "In From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
   1. [5.1 Experiment 1](https://arxiv.org/html/2404.16130v2#S5.SS1 "In 5 Results ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
   2. [5.2 Experiment 2](https://arxiv.org/html/2404.16130v2#S5.SS2 "In 5 Results ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
6. [6 Discussion](https://arxiv.org/html/2404.16130v2#S6 "In From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
   1. [6.1 Limitations of evaluation approach](https://arxiv.org/html/2404.16130v2#S6.SS1 "In 6 Discussion ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
   2. [6.2 Future work](https://arxiv.org/html/2404.16130v2#S6.SS2 "In 6 Discussion ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
7. [7 Conclusion](https://arxiv.org/html/2404.16130v2#S7 "In From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
8. [A Entity and Relationship Extraction Approach](https://arxiv.org/html/2404.16130v2#A1 "In From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
   1. [A.1 Entity Extraction](https://arxiv.org/html/2404.16130v2#A1.SS1 "In Appendix A Entity and Relationship Extraction Approach ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
   2. [A.2 Self-Reflection](https://arxiv.org/html/2404.16130v2#A1.SS2 "In Appendix A Entity and Relationship Extraction Approach ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
9. [B Example Community Detection](https://arxiv.org/html/2404.16130v2#A2 "In From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
10. [C Context Window Selection](https://arxiv.org/html/2404.16130v2#A3 "In From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
11. [D Example Answer Comparison](https://arxiv.org/html/2404.16130v2#A4 "In From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
12. [E System Prompts](https://arxiv.org/html/2404.16130v2#A5 "In From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
    1. [E.1 Element Instance Generation](https://arxiv.org/html/2404.16130v2#A5.SS1 "In Appendix E System Prompts ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
    2. [E.2 Community Summary Generation](https://arxiv.org/html/2404.16130v2#A5.SS2 "In Appendix E System Prompts ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
    3. [E.3 Community Answer Generation](https://arxiv.org/html/2404.16130v2#A5.SS3 "In Appendix E System Prompts ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
    4. [E.4 Global Answer Generation](https://arxiv.org/html/2404.16130v2#A5.SS4 "In Appendix E System Prompts ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
13. [F Evaluation Prompts](https://arxiv.org/html/2404.16130v2#A6 "In From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
    1. [F.1 Relative Assessment Prompt](https://arxiv.org/html/2404.16130v2#A6.SS1 "In Appendix F Evaluation Prompts ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
    2. [F.2 Relative Assessment Metrics](https://arxiv.org/html/2404.16130v2#A6.SS2 "In Appendix F Evaluation Prompts ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
14. [G Statistical Analysis](https://arxiv.org/html/2404.16130v2#A7 "In From Local to Global: A GraphRAG Approach to Query-Focused Summarization")
...
(which can be among people, places, and events) in order to anticipate their trajectories and act effectively*” (Klein et al.,, [2006](https://arxiv.org/html/2404.16130v2#bib.bib27)).
...
GraphRAG contrasts with these approaches by focusing on a previously unexplored quality of graphs in this context: their inherent *modularity* (Newman,, [2006](https://arxiv.org/html/2404.16130v2#bib.bib45)) and the ability to partition graphs into nested modular communities of closely related nodes (e.g., Louvain, Blondel et al., [2008](https://arxiv.org/html/2404.16130v2#bib.bib7); Leiden, Traag et al., [2019](https://arxiv.org/html/2404.16130v2#bib.bib62)).
...
Many benchmark datasets for open-domain question answering exist, including HotPotQA (Yang et al.,, [2018](https://arxiv.org/html/2404.16130v2#bib.bib70)), MultiHop-RAG (Tang and Yang,, [2024](https://arxiv.org/html/2404.16130v2#bib.bib60)), and MT-Bench (Zheng et al.,, [2024](https://arxiv.org/html/2404.16130v2#bib.bib78)).
...
Our approach is related to LLM methods that use a corpus to generate questions whose answers would be summaries of the corpus, such as in Xu and Lapata, ([2021](https://arxiv.org/html/2404.16130v2#bib.bib69)).
...
Recent work has used LLMs for adaptive benchmarking to ensure relevance, diversity, and alignment with the target application or task (Yuan et al.,, [2024](https://arxiv.org/html/2404.16130v2#bib.bib74); [Zhang et al., 2024b,](https://arxiv.org/html/2404.16130v2#bib.bib77) ).
In this work, we propose an adaptive benchmarking approach to generating global sensemaking queries for the LLM.
Our approach builds on prior work in LLM-based persona generation, where the LLM is used to generate diverse and authentic sets of personas (Salminen et al.,, [2024](https://arxiv.org/html/2404.16130v2#bib.bib52); Shin et al.,, [2024](https://arxiv.org/html/2404.16130v2#bib.bib56); Kosinski,, [2024](https://arxiv.org/html/2404.16130v2#bib.bib28)).
...
Prior work has shown LLMs to be good evaluators of natural language generation, including work where LLMs evaluations were competitive with human evaluations ([Wang et al., 2023a,](https://arxiv.org/html/2404.16130v2#bib.bib65) ; Zheng et al.,, [2024](https://arxiv.org/html/2404.16130v2#bib.bib78)).
Some prior work proposes criteria for having LLMs quantify the quality of generated texts such as “fluency”  ([Wang et al., 2023a,](https://arxiv.org/html/2404.16130v2#bib.bib65) )
Some of these criteria are generic to vector RAG systems and not relevant to global sensemaking, such as “context relevance”, “faithfulness”, and “answer relevance” (RAGAS, Es et al., [2023](https://arxiv.org/html/2404.16130v2#bib.bib14)).
Lacking a gold standard for evaluation, one can quantify relative performance for a given criterion by prompting the LLM to compare generations from two different competing models (LLM-as-a-judge, (Zheng et al.,, [2024](https://arxiv.org/html/2404.16130v2#bib.bib78))).
...
In this manuscript, our analysis uses exact string matching for *entity matching* – the task of reconciling different extracted names for the same entity (Barlaug and Gulla,, [2021](https://arxiv.org/html/2404.16130v2#bib.bib5); Christen and Christen,, [2012](https://arxiv.org/html/2404.16130v2#bib.bib10); Elmagarmid et al.,, [2006](https://arxiv.org/html/2404.16130v2#bib.bib13)).
...
1:Input: Description of a corpus, number of users KKitalic\_K, number of tasks per user NNitalic\_N, number of questions per (user, task) combination MMitalic\_M.

2:Output: A set of K∗N∗MK\*N\*Mitalic\_K ∗ italic\_N ∗ italic\_M high-level questions requiring global understanding of the corpus.
...
5:  Collect the generated questions to produce K∗N∗MK\*N\*Mitalic\_K ∗ italic\_N ∗ italic\_M test questions for the dataset.

6:end procedure

For our evaluation, we set K=M=N=5K=M=N=5italic\_K = italic\_M = italic\_N = 5 for a total of 125 test questions per dataset.
[Table 1](https://arxiv.org/html/2404.16130v2#S3.T1 "Table 1 ‣ 3.2 Global Sensemaking Question Generation ‣ 3 Methods ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization") shows example questions for each of the two evaluation datasets.
...
An illustration of LLM assessment for answers to a sample question can be found in [Appendix D](https://arxiv.org/html/2404.16130v2#A4 "Appendix D Example Answer Comparison ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization").
...
Podcast transcripts. Public transcripts of *Behind the Tech with Kevin Scott*, a podcast featuring conversations between Microsoft CTO Kevin Scott and various thought leaders in science and technology  (Scott,, [2024](https://arxiv.org/html/2404.16130v2#bib.bib54)).
This corpus was divided into 1669 ×\times× 600-token text chunks, with 100-token overlaps between chunks (∼\sim∼1 million tokens).

News articles. A benchmark dataset comprised of news articles published from September 2013 to December 2023 in a range of categories, including entertainment, business, sports, technology, health, and science  (Tang and Yang,, [2024](https://arxiv.org/html/2404.16130v2#bib.bib60)).
...
We used a fixed context window size of 8k tokens for generating community summaries, community answers, and global answers (explained in [Appendix C](https://arxiv.org/html/2404.16130v2#A3 "Appendix C Context Window Selection ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")).
Graph indexing with a 600 token window (explained in [Section A.2](https://arxiv.org/html/2404.16130v2#A1.SS2 "A.2 Self-Reflection ‣ Appendix A Entity and Relationship Extraction Approach ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization")) took 281 minutes for the Podcast dataset, running on a virtual machine (16GB RAM, Intel(R) Xeon(R) Platinum 8171M CPU @ 2.60GHz) and using a public OpenAI endpoint for gpt-4-turbo (2M TPM, 10k RPM).

We implemented Leiden community detection using the graspologic library (Chung et al.,, [2019](https://arxiv.org/html/2404.16130v2#bib.bib11)).
The prompts used to generate the graph index and global answers can be found in [Appendix E](https://arxiv.org/html/2404.16130v2#A5 "Appendix E System Prompts ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization"), while the prompts used to evaluate LLM responses against our criteria can be found in [Appendix F](https://arxiv.org/html/2404.16130v2#A6 "Appendix F Evaluation Prompts ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization").
A full statistical analysis of the results presented in the next section can be found in [Appendix G](https://arxiv.org/html/2404.16130v2#A7 "Appendix G Statistical Analysis ‣ From Local to Global: A GraphRAG Approach to Query-Focused Summarization").
...
Podcast transcripts
501728252221835050484344725050535049755247505250785750485052795651504850000000000000Comprehensiveness
...
News articles

5054595555544650555352 52414550484847454752504949454852515049464853515150000000000000Directness
...
Comparison of fabrication rates, e.g., using approaches like SelfCheckGPT (Manakul et al.,, [2023](https://arxiv.org/html/2404.16130v2#bib.bib36)), would also strengthen the current analysis.
...
* Barlaug and Gulla, (2021)
  ...
  ACM Transactions on Knowledge Discovery from Data (TKDD), 15(3):1–37.
* Baumel et al., (2018)
...
* Dang, (2006)
  ...
  In Proceedings of the Workshop on Task-Focused Summarization and Question Answering, pages 48–55.
...
* Etzioni et al., (2004)
  ...
  In Proceedings of the 13th International Conference on World Wide Web, WWW ’04, page 100–110, New York, NY, USA. Association for Computing Machinery.
* Feng et al., (2023)
...
* Jin et al., (2021)
  ...
  IEEE Transactions on Knowledge and Data Engineering, 35(2):1149–1170.
* Kang et al., (2023)
...
* Kim et al., (2016)
  ...
  In Proceedings of the 25th ACM International on Conference on Information and Knowledge Management, CIKM ’16, page 2257–2262, New York, NY, USA. Association for Computing Machinery.
* Kim et al., (2023)
...
* Laskar et al., (2020)
  ...
  In Advances in Artificial Intelligence: 33rd Canadian Conference on Artificial Intelligence, Canadian AI 2020, Ottawa, ON, Canada, May 13–15, 2020, Proceedings 33, pages 342–348. Springer.
* Lewis et al., (2020)
...
* Shin et al., (2024)
  ...
  In Proceedings of the 2024 ACM Designing Interactive Systems Conference, pages 757–781.
* Shinn et al., (2024)
...
* Tan et al., (2017)
  ...
  In Proceedings of the 2017 ACM on Conference on Information and Knowledge Management, CIKM ’17, page 1777–1786, New York, NY, USA. Association for Computing Machinery.
* Tang and Yang, (2024)
...
* Yao et al., (2017)
  ...
  Knowledge and Information Systems, 53:297–336.
* Yao et al., (2023)
...
* Yates et al., (2007)
  ...
  In Carpenter, B., Stent, A., and Williams, J. D., editors, Proceedings of Human Language Technologies: The Annual Conference of the North American Chapter of the Association for Computational Linguistics (NAACL-HLT), pages 25–26, Rochester, New York, USA. Association for Computational Linguistics.
* Yuan et al., (2024)
...
The choice of prompt engineering techniques has a strong impact on the quality of knowledge graph extraction  (Zhu et al.,, [2024](https://arxiv.org/html/2404.16130v2#bib.bib79)), and different techniques have different costs in terms of tokens consumed and generated by the model.
*Self-reflection* is a prompt engineering technique where the LLM generates an answer, and is then prompted to evaluate its output for correctness, clarity, or completeness, then finally generate an improved response based on that evaluation (Huang et al.,, [2023](https://arxiv.org/html/2404.16130v2#bib.bib20); Shinn et al.,, [2024](https://arxiv.org/html/2404.16130v2#bib.bib57); Wang et al.,, [2022](https://arxiv.org/html/2404.16130v2#bib.bib67); Madaan et al.,, [2024](https://arxiv.org/html/2404.16130v2#bib.bib35)).
...
For example, in a sample dataset (HotPotQA, [Yang et al.,](https://arxiv.org/html/2404.16130v2#bib.bib70), [2018](https://arxiv.org/html/2404.16130v2#bib.bib70)), GPT-4 extracted almost twice as many entity references when the chunk size was 600 tokens than when it was 2400.
